import type { AvatarOption, AvatarSettings } from '@/types/index'
...
export const SHAPE_STYLE_SET = {
  [WrapperShape.Circle]: 'rounded-full',
  [WrapperShape.Square]: 'rounded-none',
  // TODO: Radius should adapt to the avatar size
  [WrapperShape.Squircle]: 'rounded-3xl',
}
